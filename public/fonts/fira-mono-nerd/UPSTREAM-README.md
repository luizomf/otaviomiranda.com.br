 ...
 * For a stable version download a font package from the [release page](https://github.com/ryanoasis/nerd-fonts/releases)
   * [FiraMono.zip](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/FiraMono.zip)
   * [FiraMono.tar.xz](https://github.com/ryanoasis/nerd-fonts/releases/latest/download/FiraMono.tar.xz) (smaller)
