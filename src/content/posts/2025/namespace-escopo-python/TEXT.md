---
title: 'Escopo e Namespace em Python'
description:
...
![Diagrama mostrando a regra LEGB do Python](./images/python-legb-rule.webp)
...
![Exemplo da call stack do Python em execução](./images/call-stack-example.webp)
