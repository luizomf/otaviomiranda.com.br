---
title: 'Tentei usar o whisper live via microfone'
description:
...
pra rodar liso num esquema _live_.
...
![Imagem de um robô triste](./images/whisper-failed-1.webp)
...
Eu não entendo muito do `sox` ainda (primeiro uso), mas usei o `ffmpeg` (lá em
cima) pra listar os dispositivos. E aqui é diferente: em vez de usar o ID como
no `ffmpeg`, tu passa o nome do dispositivo, tipo, meu caso:
